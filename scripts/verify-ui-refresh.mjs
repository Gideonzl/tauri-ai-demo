...
assertIncludes(mainLayout, '固定停靠在工作区', '悬浮助手必须停靠在中间工作区')
assertIncludes(mainLayout, 'position: absolute', '悬浮助手必须相对工作区定位')
assert.ok(!mainLayout.includes('cmd-fab-pos'), '悬浮助手不能被旧拖拽坐标带入右侧 AI 面板')
