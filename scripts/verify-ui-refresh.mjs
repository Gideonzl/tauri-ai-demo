...
assertIncludes(scriptAutomationView, 'script-editor-resize', '脚本编辑区必须提供执行目标面板的左右拖拽分隔条')
assertIncludes(scriptAutomationView, 'onTargetResizeStart', '脚本编辑区必须支持可靠的指针拖拽调整宽度')
