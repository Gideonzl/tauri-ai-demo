...
assert.ok(
  /registerDecoration\(\{\s*marker,\s*anchor:\s*'right',\s*x:\s*1,\s*width:\s*4\s*\}\)/.test(xtermFrontend),
  '终端 AI 操作必须从右侧预留四个字符格，防止按钮覆盖输出或滚动区域',
)
assert.ok(terminalPanel.includes('width: 22px'), '终端 AI 操作按钮必须保持固定 22px 宽度')
