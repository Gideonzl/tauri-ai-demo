...
.script-form-fields :deep(.el-input__wrapper) { padding: 0 10px; border: 0 !important; border-radius: 6px; background: $color-bg-input !important; box-shadow: inset 0 0 0 1px $color-border !important; }.script-form-fields :deep(.el-input.is-focus .el-input__wrapper), .script-form-fields :deep(.el-input__wrapper:hover) { box-shadow: inset 0 0 0 1px $color-border !important; }.script-form-fields :deep(.el-input__inner) { background: transparent !important; }.script-name-input :deep(.el-input__inner) { height: 30px; font-size: 15px; font-weight: 600; color: $color-text-primary; letter-spacing: 0; }.script-description-input :deep(.el-input__inner) { height: 24px; color: $color-text-secondary; font-size: 12px; letter-spacing: 0; }
