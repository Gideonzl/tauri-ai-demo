...
export const useSshStore = defineStore('ssh', () => {
  ...
  return { servers, groups, sessions, activeSessionId, activeSession, showConnectDialog, editingServer, searchQuery, selectedGroupId, quickCommands, openFiles, activeFileIndex, filteredServers, allGroupNames, addServer, updateServer, deleteServer, addGroup, deleteGroup, renameGroup, addQuickCommand, updateQuickCommand, deleteQuickCommand, createSession, updateSessionStatus, closeSession, switchSession, init }
})
